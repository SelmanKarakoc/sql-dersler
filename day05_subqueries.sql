...
----------------------------------------------------------------*/
select sirket,personel_sayisi, (select avg(maas) from personel where sirketler.sirket=personel.sirket )
from sirketler;
...
----------------------------------------------------------------*/
select sirket_id,sirket,(select count(sehir) from personel where sirketler.sirket=personel.sirket ) toplam_sehir
from sirketler
where sirket_id>101;
...
----------------------------------------------------------------*/ 
select sirket,personel_sayisi,(select max(maas) from personel where personel.sirket=sirketler.sirket)max_maas,
(select min(maas) from personel where personel.sirket=sirketler.sirket)min_maas
from sirketler;
...
select sirket,personel_sayisi,(select sum(maas) from personel where personel.sirket=sirketler.sirket)toplam_maas
from sirketler;
