...
isim varchar(10),
irtibat varchar(15),
constraint tedarik_pk primary key(id));
...
/*-------------------------------------------------------------------------
5) Tum cocuklarin grade lerini  puanlar tablosundaki yazili notlarini ile update edin. 
--------------------------------------------------------------------------*/
update cocuklar
...
-- 3) Ismi A ile başlayan olanlarin urun_fiyatlarini %15 artirin 
update mart_satislar
set urun_fiyat=urun_fiyat+(urun_fiyat*0.15)
