...
delete from cucuklar where veli_isim='Ali' or veli_isim='Ayse';

delete from cucuklar where veli_isim in ('Ali' 'Ayse');
...
CREATE TABLE cocuk
   ...
   savepoint V1;
    ...
    -- id si 124 ten buyuk olanları sil
...
delete from cocuklar where id>124;
